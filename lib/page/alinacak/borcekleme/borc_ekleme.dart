...
import 'package:hesapp/page/alinacak/borcekleme/view_borcekleme.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Yeni Borc Ekleme Sayfası'),
        ),
        body: Center(
          child: Padding(
                        ...
                        builder: (context, state) {
                          if (state.isNotEmpty) {
                            return DropdownButton<UserModel>(
                              value: borcluUser,
                              // Initial value, is set to the first item in the state list
